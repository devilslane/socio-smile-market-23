...
const Consultation = () => {
  ...
  const handleContinue = () => {
    if (step === 1) {
      ...
      // Go to dashboard (would be implemented in a real app)
      navigate('/');
      toast({
        title: "Success!",
                        ...
                        {paymentMethods.map((method) => {
                          ...
                          return (
                            <div
                              ...
                              `}
                              onClick={() => !isDisabled && setPaymentMethod(method.id as PaymentMethod)}
                            >
                    ...
                    <div className="max-w-md mx-auto bg-gray-50 rounded-lg p-4 mb-6 text-left">
                      ...
                      <div className="grid grid-cols-2 gap-y-2 text-sm">
                        ...
                        <div className="font-medium">
                          ...
                          {paymentMethod === 'mobile' && 'Google Pay/UPI'}
